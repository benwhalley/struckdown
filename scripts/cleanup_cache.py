...
if __name__ == "__main__":
    ...
    print(f"Cache before: {stats_before['file_count']} files, {stats_before['total_size_mb']}MB")
    ...
    if result["files_deleted"] > 0:
        ...
        print(f"Cache after: {stats_after['file_count']} files, {stats_after['total_size_mb']}MB")
    else:
